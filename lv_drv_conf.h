...
#  if EVDEV_SCALE
#    define EVDEV_SCALE_HOR_RES     (3400)          /* Horizontal resolution of touchscreen */
#    define EVDEV_SCALE_VER_RES     (3400)          /* Vertical resolution of touchscreen */
#  endif  /*EVDEV_SCALE*/

#  define EVDEV_CALIBRATE         1               /*Scale and offset the touchscreen coordinates by using maximum and minimum values for each axis*/
#  if EVDEV_CALIBRATE
#    define EVDEV_HOR_MIN   3700                    /*If EVDEV_XXX_MIN > EVDEV_XXX_MAX the XXX axis is automatically inverted*/
#    define EVDEV_HOR_MAX   400
#    define EVDEV_VER_MIN   770
#    define EVDEV_VER_MAX   3530
#  endif  /*EVDEV_SCALE*/
#endif  /*USE_EVDEV*/
